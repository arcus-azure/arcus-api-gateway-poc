...
namespace Arcus.API.Bacon.Correlation.WebApi.Middleware
{
    /// <summary>
    /// Correlate the incoming request with the outgoing response by using previously configured <see cref="CorrelationInfoOptions"/>.
    /// </summary>
    public class CorrelationWithUpstreamApiGatewayMiddleware
    {
        private readonly RequestDelegate _next;
        private readonly ILogger _logger;

        /// <summary>
        /// Initializes a new instance of the <see cref="CorrelationWithUpstreamApiGatewayMiddleware"/> class.
        /// </summary>
        ...
        public CorrelationWithUpstreamApiGatewayMiddleware(
            RequestDelegate next,
            ILogger<CorrelationWithUpstreamApiGatewayMiddleware> logger)
        {
        ...
        public async Task Invoke(HttpContext httpContext, HttpWithUpstreamApiGatewayCorrelation service)
        {
