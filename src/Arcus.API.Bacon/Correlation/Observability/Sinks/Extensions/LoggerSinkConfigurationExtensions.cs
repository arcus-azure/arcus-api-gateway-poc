using System;
using Arcus.API.Bacon.Correlation.Observability.Sinks.Configuration;
using Arcus.API.Bacon.Correlation.Observability.Sinks.Converters;
...
namespace Serilog.Configuration
{
    ...
    public static class LoggerSinkConfigurationExtensions
    {
        ...
        public static LoggerConfiguration AzureApplicationInsightsOnSteroids(
            ...
            string instrumentationKey)
        {
            ...
            return AzureApplicationInsightsOnSteroids(loggerSinkConfiguration, instrumentationKey, configureOptions: null);
        }
            ...
            Action<ApplicationInsightsSinkOptions> configureOptions)
        {
            ...
            return AzureApplicationInsightsOnSteroids(loggerSinkConfiguration, instrumentationKey, LogEventLevel.Verbose, configureOptions);
        }
            ...
            LogEventLevel restrictedToMinimumLevel)
        {
            ...
            return AzureApplicationInsightsOnSteroids(loggerSinkConfiguration, instrumentationKey, restrictedToMinimumLevel, configureOptions: null);
        }
            ...
            Action<ApplicationInsightsSinkOptions> configureOptions)
        {
            ...
            return loggerSinkConfiguration.ApplicationInsights(instrumentationKey, CustomApplicationInsightsTelemetryConverter.Create(options), restrictedToMinimumLevel);
        }
    }
}