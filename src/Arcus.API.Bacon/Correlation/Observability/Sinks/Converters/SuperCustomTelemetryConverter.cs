...
namespace Arcus.API.Bacon.Correlation.Observability.Sinks.Converters
{
    ...
    public abstract class SuperCustomTelemetryConverter<TEntry> : TelemetryConverterBase
        where TEntry : ITelemetry, ISupportProperties
    {
        private readonly SuperCustomOperationContextConverter _superCustomOperationContextConverter = new SuperCustomOperationContextConverter();
...
#pragma warning restore 618
            ...
            _superCustomOperationContextConverter.EnrichWithCorrelationInfo(telemetryEntry);
