...
using CustomDependencyTelemetryConverter = Arcus.API.Bacon.Correlation.Observability.Sinks.Converters.Dependencies.CustomDependencyTelemetryConverter;
...
using HttpDependencyTelemetryConverter = Arcus.API.Bacon.Correlation.Observability.Sinks.Converters.Dependencies.HttpDependencyTelemetryConverter;
using SqlDependencyTelemetryConverter = Arcus.API.Bacon.Correlation.Observability.Sinks.Converters.Dependencies.SqlDependencyTelemetryConverter;
...
namespace Arcus.API.Bacon.Correlation.Observability.Sinks.Converters
{
    /// <summary>
