...
namespace Arcus.API.Bacon.Correlation.Observability.Sinks.Converters
{
    ...
    /// </summary>
    public class SuperCustomExceptionTelemetryConverter : CustomTelemetryConverter<ExceptionTelemetry>
    {
        ...
        public SuperCustomExceptionTelemetryConverter(ApplicationInsightsSinkExceptionOptions options)
        {
